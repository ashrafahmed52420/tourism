...
{
    public partial class booktr3 : Form
    {
        public booktr3()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                // Use integerValue
                string net = (pint * 11000).ToString(); // Convert result to string
        ...
        private void booktr3_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
    }
